...
<head>
	...
	<meta content="Police National du Burundi" name="description">
	<meta content="Burundi Police National" name="keywords">
	...
	<title> @yield('title', 'Police National du Burundi')</title>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<div class="widget subscribe no-box">
						<h5 class="widget-title">POLICE NATIONAL DU BURUNDI<span></span></h5>
						<p>Lorem ipsum dolor, sit amet consectetur, adipisicing elit. Alias delectus dolorem modi eveniet sunt deserunt non nihil optio, ratione animi corrupti eligendi placeat doloribus sed asperiores accusantium ipsa consectetur quas. </p>
					</div>
				</div>

				<div class="col-xs-12 col-sm-6 col-md-4">
					<div class="widget no-box">
						<h5 class="widget-title">Les liens utiles<span></span></h5>
						<ul class="thumbnail-widget">
							<li>
								<div class="thumb-content"><a href="#.">Présidance</a></div>	
							</li>

							<li>
								<div class="thumb-content"><a href="#.">OBR</a></div>	
							</li>
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					...
					<div class="widget no-box">
						...
						<h5 class="widget-title">Tél : +257 000 000<span></span></h5>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<p>Copyright Jean Lionel © 2020. All rights reserved.</p>
				</div>
			</div>
		</div>
	</div>
