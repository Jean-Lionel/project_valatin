	...
	<header class="container-fluid">
		<div class="row"  style="background:rgba(28,40,170,0.8);">
			<div class="col-sm-12 col-md-3">
				<img src="image/logo.jpg" alt="Logo de la Police National du burundi">
			</div>
			<div class="col-sm-12 col-md-6"><h3>Police National du Burundi</h3></div>
			<div class="col-sm-12 col-md-3">
				<img src="image/flag-anime.gif" alt="Le drapeau du Burundi">
			</div>
		</div>
		...
		<nav class="mt-4 sticky-top container-fluid" >
			<div class="row nav-bar">
				...
				<div class="dropdown">
					...
					<div class="dropdown-content">
						<a href="#">Communique de presse</a>
						<a href="#">Police Magazine</a>
						<a href="#">Sport</a>
					</div>
				</div>
				...
				<div class="dropdown" >
					<span class="dropbtn" >Contacts</span>
						<div class="dropdown-content">
							<a href="#">Numéro d'urgence</a>
							<a href="#">Inspection général</a>
							<a href="#">Commissariats Généraux</a>
							<a href="#">Commissariats Pronvenciaux</a>
						</div>
					</div>
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<div class="carousel-item @if($i === 0) active @endif">
						<img class="d-block w-100" src="{{ asset('./images/slides/1603539090.jpeg') }}" alt="First slide">

						<div class="carousel-caption d-none d-md-block">
							<h5>Mon ordinateur Preferer</h5>
							<p> Utiliser l'ordinateur est tres cool</p>
						</div>
		...
		<div class="article-recent">
			...
			<div class="pt-5 container">
				<div class="row d-flex justify-items-center align-items-center">
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 mb-4">
						<a href="javascript:;" class="card-ui card">
							<div class="overlay"></div>
							<div class="card-body">
								<h5 class="card-title">The Guardian's Darkness</h5>
								...
								<span class="badge badge-dark font-weight-bold p-2">9 comments</span>
							</div>
						</a>
					</div>
			...
			<div class="pt-5 container">
				<div class="row d-flex justify-items-center align-items-center">
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 mb-4">
						<a href="javascript:;" class="card-ui card">
							<img class="card-img mt-1" src="http://lorempixel.com/640/360" alt="Card image">
							<div class="overlay"></div>
							<div class="card-body">
								<h5 class="card-title my-2">Licence 1ére année</h5>
								<p class="card-text">Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression.</p>
								<span class="badge badge-dark font-weight-bold p-2">9 comments</span>
							</div>
						</a>
			...
			<a class="my-blog" href="https://nadjmandev.com">By Nadjmandev</a>
