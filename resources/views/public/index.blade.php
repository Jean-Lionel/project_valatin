...
@section('content')
		...
		<div id="slide" class="mt-3 container-fluid">
			...
			<div class="">
				...
				<div class="row">
					<div class="col-sm-12 col-md-8">
						<h1>Police National du Burundi</h1>
						<div class="jumbotron">
							<p>
				...
				<div class="row d-flex justify-items-center align-items-center">
					...
					@for ($i = 0; $i < sizeof($articles)  ; $i++)
						...
						<a href="{{ route('article',$articles[$i]->title ) }}" class="card-ui card">
							...
							<img class="card-img mt-1" src="{{ asset('./images/'.$articles[$i]->image_url) }}" width="640" height="360" alt="Card image">
